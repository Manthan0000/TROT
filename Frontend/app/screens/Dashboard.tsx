      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.settingsSection}>
            ...
            <Text style={styles.settingsSubtitle}>Manage your experience</Text>
            ...
            <View style={styles.cardsGrid}>
              ...
              <TouchableOpacity style={styles.settingsCard} onPress={handleSuggestion}>
                ...
                <View style={styles.cardContent}>
                  ...
                  <Text style={styles.cardSubtitle}>Give suggestion ></Text>
                </View>
              </TouchableOpacity>
            ...
            <View style={styles.helpSection}>
              <Text style={styles.helpTitle}>Do you need our help?</Text>
